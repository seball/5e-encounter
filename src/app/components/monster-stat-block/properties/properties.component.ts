...
import { MonsterProficieny, Senses } from '../../../interfaces/monster.interface';
...
export class PropertiesComponent {
  ...
  getFormattedStrings(prefix: string): string {
    const filteredProficiencies = this.proficiencies.filter(p => p.proficiency.index.startsWith(prefix));
    return filteredProficiencies.map(st => {
